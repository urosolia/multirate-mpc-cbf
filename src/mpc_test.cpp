...
int main (int argc, char *argv[])
{
	...
	linearization_IC_[1] = 4.5;
	linearization_IC_[2] = M_PI/2;
	...
	double x_IC[nx_] = {  linearization_IC_[0], linearization_IC_[1],   linearization_IC_[2], 0.0,      0.0,            0.0,    0.0};  // initial condition to
	double x_g[nx_]  = {  linearization_IC_[0], linearization_IC_[1]-1,   linearization_IC_[2], 0.0,      0.0,            0.0,    0.0};  // initial condition to
